...
try:
    ...
    if pers == 'NASUS':
        ...
        sleep(3)
        print(f'{Color.BLUE}[Por consequência do tempo, a prisão se enfraqueceu e {Color.YELLOW}Renekton{Color.BLUE} conseguiu se  ]\n')
        sleep(4)
        ...
        if hist[0] == 'S' and forcusu < forcmaq:
            print(f'Após ser atingido por seu irmão, {Color.GREEN}Nasus{Color.BLUE} cai no chão e pede clemencia, pedindo um tempo para se explicar.\n')
            sleep(3)
